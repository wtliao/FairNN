...
from functions.classifier_metrics import accuracy_calculate_gender_ae, EO_evaluation_ae, balanced_accuracy_gender_ae
...
def model_train(train_loader, val_loader, test_loader, train_val_loader, iteration, learning_rate, save_path, plot_path):
    ...
    for iter in range(iteration):
        if iter <= par.C_ITER:
            ...
            data4train = train_val_loader  # after 500 iteration we add all data for training
...
if __name__ == '__main__':
    ...
    print(len(MyDataset))
    train_db, val_db, test_db, train_val_db = dataset_splite(MyDataset, 22588, 1000, 22587)
